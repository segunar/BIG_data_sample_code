...
#---------------------------------------
def print_key_value(letter, num_words, total_length, total_words, my_output_stream):
    # 1. We compute the average
    average = (total_length * 1.0) / (num_words * 1.0)

    # 2. We compute the percentage
    percentage = ((num_words * 1.0) / (total_words * 1.0)) * 100.0

    # 3. We come up with the String to be printed
    my_str = letter + '\t' + "(" + str(average) + ", " + str(percentage) + ")" + '\n'
...
def my_reduce(my_input_stream, my_output_stream, my_reducer_input_parameters):
    ...
    total_words = my_reducer_input_parameters[0]
    ...
    for line in my_input_stream:
        ...
        if (new_letter != current_letter):
            ...
            if current_letter != "":
                print_key_value(current_letter, current_num_words, current_total_length, total_words, my_output_stream)
...
if __name__ == '__main__':
    ...
    # 2. Debug Names
    input_file_example = "../../my_result/Second_Round_MapReduce/my_sort_results.txt"
    output_file_example = "../../my_result/Second_Round_MapReduce/my_reducer_results.txt"
